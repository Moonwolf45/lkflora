!function (e, t) {
  ...
  var m = {
    ...
    }, _ = {ENTER: 13, ESC: 27, TAB: 9, SPACE: 32, UP: 38, DOWN: 40}, x = {
    ...
    E = new RegExp("[\\-\\+\\\\\\?!@#$%^&]+", "g"), k = {
      escapeHtml: function (e) {
        ...
        var n = y.compact(e.split(C)), i = n.pop(), s = y.minus(n, t);
        return s.push(i), s
      ...
      matchByNormalizedQuery: function (e) {
        ...
        return function (t, n) {
          ...
          return 1 === n.length && (e && y.each(e, function (e, t) {
            var i = b.getDeepValue(n[0], t), o = i && k.splitTokens(k.split(i, e));
    ...
    D = [{id: "kladr_id", fields: ["kladr_id"], forBounds: !1, forLocations: !0}, {
      ...
      composeValue: function (e, t) {
        var n = e.region_with_type || y.compact([e.region, e.region_type]).join(" ") || e.region_type_full,
          ...
          u = y.compact([e.flat_type, e.flat]).join(" "), c = e.postal_box && "а/я " + e.postal_box;
        return n === s && (n = ""), t && t.saveCityDistrict || (t && t.excludeCityDistrict ? a = "" : a && !e.city_district_fias_id && (a = "")), y.compact([n, i, s, a, o, r, l, u, c]).join(", ")
      },
      formatResult: function () {
        ...
        return D.forEach(function (n) {
          ...
          var o, a, r, l = this, u = i.data && i.data.city_district_with_type, c = s && s.unformattableTokens,
    ...
    }, $ = {LEGAL: [2, 2, 5, 1], INDIVIDUAL: [2, 2, 6, 2]}, F = {
      urlSuffix: "party",
      noSuggestionsHint: "Неизвестная организация",
      matchers: [L.matchByFields({value: null, "data.address.value": R, "data.inn": null, "data.ogrn": null})],
      dataComponents: D,
      enrichmentEnabled: !0,
      ...
      formatResult: function (e, t, n, o) {
        var a = this, r = a.type.formatResultInn.call(a, n, t),
          l = a.highlightMatches(b.getDeepValue(n.data, "ogrn"), t, n), u = i(r, l),
          c = a.highlightMatches(b.getDeepValue(n.data, "management.name"), t, n),
          d = b.getDeepValue(n.data, "address.value") || "";
        return a.isMobile && ((o || (o = {})).maxLength = 50), e = s.call(a, e, b.getDeepValue(n.data, "name.latin"), t, n, o), e = a.wrapFormattedValue(e, n), d && (d = d.replace(/^(\d{6}?\s+|Россия,\s+)/i, ""), d = a.isMobile ? d.replace(new RegExp("^([^" + w + "]+[" + w + "]+[^" + w + "]+).*"), "$1") : a.highlightMatches(d, t, n, {unformattableTokens: R})), (u || d || c) && (e += '<div class="' + a.classes.subtext + '"><span class="' + a.classes.subtext_inline + '">' + (u || "") + "</span>" + (i(d, c) || "") + "</div>"), e
      },
      ...
      matchers: [L.matchByFields({value: null, "data.bic": null, "data.swift": null})],
      dataComponents: D,
      geoEnabled: !0,
      formatResult: function (e, t, n, i) {
        var s = this, o = s.highlightMatches(b.getDeepValue(n.data, "bic"), t, n),
          a = b.getDeepValue(n.data, "address.value") || "";
        return e = s.highlightMatches(e, t, n, i), e = s.wrapFormattedValue(e, n), a && (a = a.replace(/^\d{6}( РОССИЯ)?, /i, ""), a = s.isMobile ? a.replace(new RegExp("^([^" + w + "]+[" + w + "]+[^" + w + "]+).*"), "$1") : s.highlightMatches(a, t, n, {unformattableTokens: R})), (o || a) && (e += '<div class="' + s.classes.subtext + '"><span class="' + s.classes.subtext_inline + '">' + o + "</span>" + a + "</div>"), e
      },
      formatSelected: function (e) {
        return b.getDeepValue(e, "data.name.payment") || null
      }
    }, N = {NAME: q, ADDRESS: I, PARTY: F, EMAIL: A, BANK: z};
  N.get = function (e) {
    return N.hasOwnProperty(e) ? N[e] : new o(e)
  }, P.extend(B, {suggest_local: !0});
  var M = {
    ...
    suggest: {
      defaultParams: {type: j.getDefaultType(), dataType: "json", contentType: j.getDefaultContentType()},
      addTypeInUrl: !0
    },
  ...
  a.prototype = {
    initialize: function () {
      var e = this;
      e.uniqueId = j.uniqueId("i"), e.createWrapper(), e.notify("initialize"), e.bindWindowEvents(), e.setOptions(), e.fixPosition()
      ...
      var n = this, i = j.slice(arguments, 1);
      ...
      t.$viewport.on("resize" + S + t.uniqueId, n).on("scroll" + S + t.uniqueId, n)
    }, unbindWindowEvents: function () {
      this.$viewport.off("resize" + S + this.uniqueId).off("scroll" + S + this.uniqueId)
      ...
      var n = this;
      e.extend(n.options, t), n.type = N.get(n.options.type), e.each({requestMode: W}, function (t, i) {
      ...
      var i = this, s = e.trim(i.options.token), o = e.trim(i.options.partner), r = i.options.serviceUrl,
        l = i.options.url, u = H[t], c = e.extend({timeout: i.options.timeout}, u.defaultParams), d = {};
      ...
      var i = this, s = i.options, o = e.isFunction(s.params) ? s.params.call(i.element, t) : e.extend({}, s.params);
      ...
      var s, o = this, a = o.options, r = i && i.noCallbacks, l = i && i.useEnrichmentCache,
        u = i && i.method || o.requestMode.method, c = o.constructRequestParams(t, n), d = e.param(c || {}),
        f = e.Deferred();
      ...
      var i = this, s = e.ajax(i.getAjaxParams(n, {data: j.serialize(t)}));
  ...
  e.extend(a.prototype, U), M.on("initialize", U.bindElementEvents).on("dispose", U.unbindElementEvents);
  var Q = {};
  r();
  var Z = {
    checkStatus: function () {
      ...
      var t = this, n = t.options.token && t.options.token.trim() || "", i = t.options.type + n, s = Q[i];
  ...
  "GET" != j.getDefaultType() && (e.extend(B, {geoLocation: G}), e.extend(a, {resetLocation: l}), e.extend(a.prototype, {getGeoLocation: J.getGeoLocation}), M.on("setOptions", J.checkLocation).on("requestParams", J.constructParams));
  var X = {
    enrichSuggestion: function (t, n) {
      ...
      i.disableDropdown();
      var o = i.type.getEnrichmentQuery(t), a = i.type.enrichmentParams,
        r = {noCallbacks: !0, useEnrichmentCache: !0, method: i.type.enrichmentMethod};
  ...
  var Y = {width: "auto", floating: !1}, ee = {
    createContainer: function () {
      ...
      } : {left: e.left + "px", top: e.top + t.borderTop + t.innerHeight + "px"}, j.delay(function () {
      ...
      var n = this, i = j.getDeepValue(t.data, "state.status");
      ...
      var o, a, r, l, d, f, p, h = this, g = [], m = s && s.unformattableTokens, y = s && s.maxLength,
        v = j.reWordExtractor();
      if (!t) return "";
      ...
      for (d = 0; d < g.length; d++) f = g[d], !f.matchable || f.matched || -1 !== e.inArray(f.formatted, m) && !f.hasUpperCase || e.each(a, function (e, t) {
        ...
        if (i) return i = {
          ...
          matchable: !0
        }, {text: i.beforeDelimiter}), s += 2, n = i.before.length, f.text = f.text.substr(n), f.formatted = f.formatted.substr(n), d--), n = i.text.length + i.after.length, f.formatted.length > n && (g.splice(s, 0, {
      ...
      if (a && d(t, n) && n.data && (e.each(a, function (e) {
        ...
        for (; (i = l.exec(j.formatToken(n.value))) && (s = i[1]);) e.each(r, function (e, t) {
  ...
  var te = {addon: null}, ne = {NONE: "none", SPINNER: "spinner", CLEAR: "clear"}, ie = function (e) {
  ...
  ie.prototype = {
    checkType: function () {
      var e = this.owner.options.addon, t = !1;
      ...
      var t = this.owner.el, n = {paddingRight: this.width};
      this.width > this.initialPadding && (this.stopBackground(), e ? t.css(n) : t.animate(n, {
        duration: "fast",
        queue: "addon"
      }).dequeue("addon"))
    }, hideBackground: function (e) {
      var t = this.owner.el, n = {paddingRight: this.initialPadding};
  ...
  var oe = {constraints: null, restrict_value: !1},
  ...
  var ue = {
    createConstraints: function () {
      ...
      var t = this, n = P.select(e.target).closest("li"), i = n.attr("data-constraint-id");
    ...
    proceedQuery: function (e) {
      ...
      if (!i.triggering.Select) {
        ...
        n = i.hasSameValues(s), i.enrichSuggestion(s, t).done(function (s, o) {
          var r = P.extend({hasBeenEnriched: o, hasSameValues: n}, t);
      ...
      var t = this, n = j.slice(arguments, 1), i = t.options["on" + e];
  ...
  var de = {bounds: null}, fe = {
    setupBounds: function () {
      this.bounds = {from: null, to: null}
    }, setBoundsOptions: function () {
      var t, n, i = this, s = [], o = e.trim(i.options.bounds).split("-"), a = o[0], r = o[o.length - 1], l = [],
        u = [];
  ...
  }, M.on("assignSuggestions", g), a.defaultOptions = B, a.version = "19.4.2", e.Suggestions = a, e.fn.suggestions = function (t, n) {
...
!function (e, t) {
  ...
  function t(e, t) {
    var n = e.data && e.data[t];
    return n && new RegExp("^" + v.escapeRegExChars(n) + "([" + g + "]|$)", "i").test(e.value)
  }
  ...
  function s(t, n) {
    var i = this;
    i.element = t, i.el = e(t), i.suggestions = [], i.badQueries = [], i.selectedIndex = -1, i.currentValue = i.element.value, i.intervalId = 0, i.cachedResponse = {}, i.enrichmentCache = {}, i.currentRequest = null, i.inputPhase = e.Deferred(), i.fetchPhase = e.Deferred(), i.enrichPhase = e.Deferred(), i.onChangeTimeout = null, i.triggering = {}, i.$wrapper = null, i.options = e.extend({}, _, n), i.classes = {
      hint: "suggestions-hint",
      mobile: "suggestions-mobile",
      nowrap: "suggestions-nowrap",
      selected: "suggestions-selected",
  ...
  var d = {ENTER: 13, ESC: 27, TAB: 9, SPACE: 32, UP: 38, DOWN: 40}, f = ".suggestions", p = "suggestions",
    g = "\\s\"'~\\*\\.,:\\|\\[\\]\\(\\)\\{\\}<>№", h = new RegExp("[" + g + "]+", "g"), m = "\\-\\+\\/\\\\\\?!@#$%^&",
    y = new RegExp("[" + m + "]+", "g"), v = function () {
      var t = 0;
      return {
        escapeRegExChars: function (e) {
          return e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&")
          ...
          var n, i;
          return n = this.compact(this.formatToken(e).split(h)), i = this.arrayMinus(n, t), n = this.withSubTokens(i.concat(this.arrayMinus(n, i)))
        }, formatToken: function (e) {
          return e && e.toLowerCase().replace(/[ёЁ]/g, "е")
      ...
      return {
        matchByNormalizedQuery: function (t, n) {
          var i = t.toLowerCase(), s = this && this.stopwords, o = v.normalize(i, s), a = [];
          return e.each(n, function (e, t) {
          ...
          return n(i) && (s = v.withSubTokens(v.getWords(a, o)), e.each(i, function (e, t) {
            ...
            0 === v.arrayMinus(s, i).length && r.push(e)
          })), 1 === r.length ? r[0] : -1
          ...
          return i(n) && (s = v.withSubTokens(v.getWords(a, o)), e.each(n, function (e, t) {
            ...
            if (v.stringEncloses(a, n)) return !1;
            var i = v.withSubTokens(v.getWords(n, o));
            return 0 === v.arrayMinus(s, i).length ? (r = e, !1) : void 0
          })), r
        }, matchByFields: function (t, n) {
          var i = this && this.stopwords, s = this && this.fieldsStopwords,
            o = v.withSubTokens(v.getWords(t.toLowerCase(), i)), a = [];
          return 1 === n.length && (s && e.each(s, function (e, t) {
            var i = v.getDeepValue(n[0], e), s = i && v.withSubTokens(v.getWords(i.toLowerCase(), t));
            s && s.length && (a = a.concat(s))
          }), 0 === v.arrayMinusWithPartialMatching(o, a).length) ? 0 : -1
        }
      }
    }(), _ = {
      autoSelectFirst: !1,
  ...
  k.NAME = {
    ...
    urlSuffix: "address",
    matchers: [e.proxy(b.matchByNormalizedQuery, {stopwords: x}), e.proxy(b.matchByWordsAddress, {stopwords: x})],
    dataComponents: w,
    ...
    composeValue: function (e, t) {
      var n, i = e.region_with_type || v.compact([e.region, e.region_type]).join(" ") || e.region_type_full,
        s = e.area_with_type || v.compact([e.area_type, e.area]).join(" ") || e.area_type_full,
        o = e.city_with_type || v.compact([e.city_type, e.city]).join(" ") || e.city_type_full,
        a = e.settlement_with_type || v.compact([e.settlement_type, e.settlement]).join(" ") || e.settlement_type_full,
        r = e.city_district_with_type || v.compact([e.city_district_type, e.city_district]).join(" ") || e.city_district_type_full,
        u = e.street_with_type || v.compact([e.street_type, e.street]).join(" ") || e.street_type_full,
        l = v.compact([e.house_type, e.house, e.block_type, e.block]).join(" "),
        c = v.compact([e.flat_type, e.flat]).join(" "), d = e.postal_box && "а/я " + e.postal_box;
      return i === o && (i = ""), t && t.saveCityDistrict || (t && t.excludeCityDistrict ? r = "" : r && !e.city_district_fias_id && (r = "")), n = v.compact([i, s, o, r, a, u, l, c, d]).join(", ")
    },
    formatResult: function () {
      var t = [], n = !1;
      return e.each(w, function () {
        ...
        var a, r, u, l = this, c = s.data && s.data.city_district_with_type, d = o && o.unformattableTokens,
          f = s.data && s.data.history_values;
        return f && f.length > 0 && (a = v.getTokens(i, d), r = this.type.findUnusedTokens(a, n), u = this.type.getFormattedHistoryValues(r, f), u && (n += u)), n = l.highlightMatches(n, i, s, o), n = l.wrapFormattedValue(n, s), c && (!l.bounds.own.length || l.bounds.own.indexOf("street") >= 0) && !e.isEmptyObject(l.copyDataComponents(s.data, t)) && (n += '<div class="' + l.classes.subtext + '">' + l.highlightMatches(c, i, s) + "</div>"), n
      }
    }(),
    findUnusedTokens: function (e, t) {
      var n, i, s = [];
      for (n in e) i = e[n], t.indexOf(i) === -1 && s.push(i);
      return s
    },
    getFormattedHistoryValues: function (e, t) {
      var n, i, s, o, a = [], r = "";
      for (s in t) {
        o = t[s];
        for (n in e) if (i = e[n], o.toLowerCase().indexOf(i) >= 0) {
          a.push(o);
          break
        }
      }
    ...
    formatResult: function (e, t, s, o) {
      var a = this, r = a.type.formatResultInn.call(a, s, t),
        u = a.highlightMatches(v.getDeepValue(s.data, "ogrn"), t, s), l = n(r, u),
        c = a.highlightMatches(v.getDeepValue(s.data, "management.name"), t, s),
        d = v.getDeepValue(s.data, "address.value") || "";
      return a.isMobile && ((o || (o = {})).maxLength = 50), e = i.call(a, e, v.getDeepValue(s.data, "name.latin"), t, s, o), e = a.wrapFormattedValue(e, s), d && (d = d.replace(/^(\d{6}?\s+|Россия,\s+)/i, ""), d = a.isMobile ? d.replace(new RegExp("^([^" + g + "]+[" + g + "]+[^" + g + "]+).*"), "$1") : a.highlightMatches(d, t, s, {unformattableTokens: x})), (l || d || c) && (e += '<div class="' + a.classes.subtext + '"><span class="' + a.classes.subtext_inline + '">' + (l || "") + "</span>" + (n(d, c) || "") + "</div>"), e
    },
    ...
    formatResult: function (e, t, n, i) {
      ...
      return e = s.highlightMatches(e, t, n, i), e = s.wrapFormattedValue(e, n), a && (a = a.replace(/^\d{6}( РОССИЯ)?, /i, ""), a = s.isMobile ? a.replace(new RegExp("^([^" + g + "]+[" + g + "]+[^" + g + "]+).*"), "$1") : s.highlightMatches(a, t, n, {unformattableTokens: x})), (o || a) && (e += '<div class="' + s.classes.subtext + '"><span class="' + s.classes.subtext_inline + '">' + o + "</span>" + a + "</div>"), e
    },
    formatSelected: function (e) {
      return v.getDeepValue(e, "data.name.payment") || null
    }
  }, e.extend(_, {suggest_local: !0});
  var E = {
    chains: {}, on: function (e, t) {
      return this.get(e).push(t), this
    }, get: function (e) {
  ...
  s.prototype = {
    initialize: function () {
      ...
      var i = this, o = e.trim(i.options.token), a = e.trim(i.options.partner), r = i.options.serviceUrl,
        u = i.options.url, l = P[t], c = e.extend({timeout: i.options.timeout}, l.defaultParams), d = {};
      ...
      var s, o = this, a = o.options, r = i && i.noCallbacks, u = i && i.useEnrichmentCache,
        l = o.constructRequestParams(t, n), c = e.param(l || {}), d = e.Deferred();
      return s = o.cachedResponse[c], s && e.isArray(s.suggestions) ? d.resolve(s.suggestions) : o.isBadQuery(t) ? d.reject() : r || a.onSearchStart.call(o.element, l) !== !1 ? o.doGetSuggestions(l).done(function (e) {
      ...
      var n = this, i = e.ajax(n.getAjaxParams(n.requestMode.method, {data: v.serialize(t)}));
      ...
      var i, s = this, o = s.options.formatSelected || s.type.formatSelected, a = n && n.hasSameValues,
        r = n && n.hasBeenEnriched, u = null;
      return e.isFunction(o) && (i = o.call(s, t)), "string" != typeof i && (i = t.value, s.type.getSuggestionValue && (u = s.type.getSuggestionValue(s, {
        suggestion: t,
        hasSameValues: a,
        hasBeenEnriched: r
      }), null !== u && (i = u))), i
  ...
  var B = {
    checkStatus: function () {
      ...
      var n = this, i = e.trim(n.options.token), s = n.options.type + i, o = L[s];
  ...
  "GET" != v.getDefaultType() && (e.extend(_, {geoLocation: R}), e.extend(s, {resetLocation: a}), e.extend(s.prototype, {getGeoLocation: D.getGeoLocation}), E.on("setOptions", D.checkLocation).on("requestParams", D.constructParams));
  var $ = {
    enrichSuggestion: function (t, n) {
      var i = this, s = e.Deferred();
  ...
  var j = {width: "auto", floating: !1}, F = {
    createContainer: function () {
      ...
      i.isMobile ? (n = i.options.floating ? {
        ...
        left: t.left + "px",
        top: t.top + t.borderTop + t.innerHeight + "px"
      } : {left: e.left + "px", top: e.top + t.borderTop + t.innerHeight + "px"}, v.delay(function () {
        var e = i.options.width;
        "auto" === e && (e = i.el.outerWidth()), i.$container.outerWidth(e)
      })), i.$container.toggleClass(i.classes.mobile, i.isMobile).css(n), i.containerItemsPadding = t.left + t.borderLeft + t.paddingLeft - s
    }, setItemsPositions: function () {
      ...
      if (n.requestMode.userSelect) {
        if (n.hasSuggestionsToChoose()) t = i.formatResult || n.type.formatResult || n.formatResult, !n.isMobile && i.hint && n.suggestions.length && s.push('<div class="' + n.classes.hint + '">' + i.hint + "</div>"), n.selectedIndex = -1, e.each(n.suggestions, function (e, i) {
          ...
          i == n.selection && (n.selectedIndex = e), s.push('<div class="' + n.classes.suggestion + '" data-index="' + e + '">'), s.push(t.call(n, i.value, n.currentValue, i, {unformattableTokens: n.type.unformattableTokens})), o && s.push('<span class="' + n.classes.subtext_label + '">' + v.escapeHtml(o) + "</span>"), s.push("</div>")
        }); else {
          if (n.suggestions.length) return void n.hide();
          s.push('<div class="' + n.classes.hint + '">' + i.noSuggestionsHint[i.type] + "</div>")
        }
        n.$container.html(s.join("")), i.autoSelectFirst && n.selectedIndex === -1 && (n.selectedIndex = 0), n.selectedIndex !== -1 && n.getSuggestionsItems().eq(n.selectedIndex).addClass(n.classes.selected), e.isFunction(i.beforeRender) && i.beforeRender.call(n.element, n.$container), n.$container.show(), n.visible = !0, n.fixPosition(), n.setItemsPositions()
      }
    }, wrapFormattedValue: function (e, t) {
      ...
      var o, a, l, c, d, f, p, g = this, h = [], y = s && s.unformattableTokens, b = s && s.maxLength,
        _ = v.reWordExtractor();
      if (!t) return "";
      for (o = v.getTokens(n, y), a = e.map(o, function (e) {
        return new RegExp("^((.*)([" + m + "]+))?(" + v.escapeRegExChars(e) + ")([^" + m + "]*[" + m + "]*)", "i")
      }); (l = _.exec(t)) && l[0];) c = l[1], h.push({
        text: c,
        hasUpperCase: c.toLowerCase() !== c,
        formatted: v.formatToken(c),
        matchable: !0
      }), l[2] && h.push({text: l[2]});
      for (d = 0; d < h.length; d++) f = h[d], !f.matchable || f.matched || e.inArray(f.formatted, y) !== -1 && !f.hasUpperCase || e.each(a, function (e, t) {
        var n, i = t.exec(f.formatted), s = d + 1;
        if (i) return i = {
          before: i[1] || "",
          beforeText: i[2] || "",
      ...
      if (b) {
        for (d = 0; d < h.length && b >= 0; d++) f = h[d], b -= f.text.length, b < 0 && (f.text = f.text.substr(0, f.text.length + b) + "...");
        h.length = d
      }
      return p = r(h), u(p, g.classes.nowrap)
    }, makeSuggestionLabel: function (t, n) {
      var i, s, o = this, a = o.type.fieldNames, r = {}, u = v.reWordExtractor(), c = [];
      if (a && l(t, n) && n.data && (e.each(a, function (e) {
        var t = n.data[e];
        t && (r[e] = v.formatToken(t))
      }), !e.isEmptyObject(r))) {
        for (; (i = u.exec(v.formatToken(n.value))) && (s = i[1]);) e.each(r, function (e, t) {
  ...
  e.extend(_, j), e.extend(s.prototype, F), E.on("initialize", F.createContainer).on("dispose", F.removeContainer).on("setOptions", F.setContainerOptions).on("fixPosition", F.setDropdownPosition).on("fixPosition", F.setItemsPositions).on("assignSuggestions", F.suggest);
  var O = "addon", q = 50, A = 1e3, M = {addon: null}, z = {NONE: "none", SPINNER: "spinner", CLEAR: "clear"},
    W = function (t) {
  ...
  W.prototype = {
    checkType: function () {
      ...
      var t = this, n = {opacity: 1};
      e ? (t.$el.show().css(n), t.showBackground(!0)) : t.$el.stop(!0, !0).delay(q).queue(function () {
        t.$el.show(), t.showBackground(), t.$el.dequeue()
      }).animate(n, "fast")
    }, hide: function (e) {
      var t = this, n = {opacity: 0};
  ...
  e.extend(_, M), E.on("initialize", N.createAddon).on("setOptions", N.checkAddonType).on("fixPosition", N.fixAddonPosition).on("clear", N.checkAddonVisibility).on("valueChange", N.checkAddonVisibility).on("request", N.checkAddonVisibility).on("resetPosition", N.stopBackground);
  ...
  e.extend(_, U), e.extend(s.prototype, G), "GET" != v.getDefaultType() && E.on("initialize", G.createConstraints).on("setOptions", G.setupConstraints).on("fixPosition", G.setConstraintsPosition).on("requestParams", G.constructConstraintsParams).on("dispose", G.unbindFromParent);
  var X = {
    proceedQuery: function (e) {
      var t = this;
      e.length >= t.options.minChars ? t.updateSuggestions(e) : t.hide()
      ...
      var n = this, i = v.slice(arguments, 1), s = n.options["on" + t];
  ...
  e.extend(_, Y), e.extend(s.prototype, J), E.on("initialize", J.setupBounds).on("setOptions", J.setBoundsOptions).on("requestParams", J.constructBoundsParams), s.defaultOptions = _, s.version = "17.10.0", e.Suggestions = s, e.fn.suggestions = function (t, n) {
