...
<style>
    ...
    *{margin:0;padding:0;text-decoration:none;box-sizing:border-box;}
    ...
    .header__row{display:flex;width:100%;-webkit-justify-content:space-between;justify-content:space-between;padding:20px 0 10px 0;}
    .header__col{float:left;width:34%;padding-right:1%;padding-left:1%;}
    .header__col .text-normal{color:#fff;font-size:12px;font-weight:bold;background:#FF437F;margin:6px 0;padding:3px 5px;}
    .header__col .text-normal_green{background:#95C71D;}
    .header__col_mw{float:left;width:32%;padding:0;}
    .header__col_tar{margin:0;text-align:right;}
    .header__image img{max-width:100%;max-height:100%;width:auto;height:auto;}
    .header__img-text{font-size:15px;color:#FF4D87;text-align:center;letter-spacing:4px;font-weight:300;}
    .main{float:left;width:100%;}
    .sample-text{font-weight:400;text-align:center;padding-bottom:5px;}
    .payment{border-collapse:collapse;}
    .payment tr td{border:1px solid #000;}
    .payment__row td:first-child{width:65%;}
    .payment__row td:nth-child(3){width:10%;}
    .payment__row td:nth-child(4){width:35%;}
    .payment__inside .payment__text{width:50%;}
    .payment__text,.goods__text{font-size:14px;font-weight:700;padding:5px;}
    .ttu{text-transform:uppercase;}
    .s-di-vam{display:inline-block;vertical-align:middle;}
    .text-small__payment{padding:0 0 5px 5px;}
    .payment__abbre{width:100%;padding:5px;}
    .text-small{font-size:14px;border-top:1px solid #000;}
    .text-small,.payment__abbre{font-weight:300;}
    .payment__abbre{text-transform:uppercase;}
    h2{font-size:20px;font-weight:700;text-align:center;padding:40px 0 10px 0;margin:0;}
    hr{background:#000;height:4px;margin-bottom:25px;margin-top:0;border:none;}
    .side-who{display:block;padding-bottom:25px;}
    .side-who__col_pt{padding-top:15px;}
    .side-who__span{float:left;display:inline-block;width:13%;padding-right:15px;font-size:12px;}
    .side-who__text{float:left;display:inline-block;width:83%;font-size:12px;font-weight:bold;}
    .goods{border-collapse:collapse;width:100%;text-align:center;}
    .goods th, .goods td{border:1px solid #000;background:#95C71D;color:#FFF;}
    ...
    .text-reg,.text-reg_one,.text-reg_two{display:inline-block;width:100%;font-weight:bold;}
    .text-reg_pb{padding-bottom:10px;}
    .text-reg_border{padding:0 10px;}
    .text-reg_initials{padding:15px 0 0 10px;}
    .footer{position:relative;float:left;width:100%;}
    .footer__row{display:block;float:left;width:100%;-webkit-align-items:baseline;align-items:baseline;margin:0 -10px;}
    .footer__col{float:left;text-align:center;padding:0 10px;}
    .one{width:16%;text-align:left;}
    .two{width:22%;}
    .three{width:20%;}
    .four{width:25%;}
    .footer__box{float:left;width:100%;}
    .footer__sign{width:50px;height:50px;}
    .footer__row_under{float:left;}
    .one_under{width:40%;text-align:left;}
    .text-reg_one,.text-reg_two{float:left;width:30%;}
    .text-reg_two{width:20%;}
    .two_under{width:20%;}
    .three_under{width:30%;}
    .footer__box_pt{padding-top: 50px;}
    .footer__seal{float:left;top:15px;left:15px;}
    ...
    <div class="main">
        ...
        <div class="side-who">
            <div class="side-who__col">
                ...
                <p class="side-who__text">
                    Общество с ограниченной ответсвенностью "Софт технолоджи", 140006, Московская обл., Люберецкий р-н,
                    Люберци г, Котельнический проезд, Дом № 29А +7 (495)215-28-12
                </p>
            </div>
        ...
        <div class="goods__total">
            <div class="goods__col">
                ...
                <p class="goods__text"><?= Yii::$app->formatter->asDecimal($amount, 2); ?></p>
            </div>
            <div class="goods__col">
        ...
        <p class="text-normal">Всего наименований 1, на сумму <?= Yii::$app->formatter->asDecimal($amount, 2); ?> руб.</p>
        <p class="text-reg text-reg_pb"><?= Sum2Str::toStr($amount); ?></p>
        <hr>
    </div>
    <div class="footer">
