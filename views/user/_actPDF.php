...
<div class="container">
    <h1 class="text-big tac">АКТ № <?php echo $model['invoice_number']; ?> от
    ...
    <div class="face">
        ...
        <div class="face__row">
            ...
            <div class="face__col two_col">
                <p class="text-midl ttu text-midl_pb">ООО "Всегда дари цветы"</p>
                <p class="text-small">контрагент</p>
            </div>
            <div class="face__col three_col">
                <p class="text-midl">в лице</p>
            ...
            <div class="face__col four_col">
                <p class="text-midl text-midl_pb">Богданов С.В.</p>
                <p class="text-small">должность, ФИО</p>
            </div>
            <div class="face__col five_col">
    ...
    <p class="text-norm text-norm_pt15">Шесть тысяч рублей 00 копеек</p>
    <hr>
    ...
    <div class="footer">
        <div class="footer__row">
            ...
            <div class="footer__col">
                ...
                <p class="text-midl ttu tac border">Общество с ограниченной ответсвенностью "Всегда дари цветы"</p>
                <div class="footer__block">
                    <div class="footer__box">
                        <p class="text-midl s-di-vam one_p">ИНН</p>
                        <p class="text-midl s-di-vam border two_p">2635834309</p>
                    </div>
                    <div class="footer__box">
                        <p class="text-midl text-midl_pl s-di-vam one_p">КПП</p>
                        <p class="text-midl s-di-vam border two_p">263501001</p>
                    </div>
                </div>
                <div class="footer__item">
                    <div class="item-first">
                    ...
                    <div class="item-second item-second_address">
                        <p class="text-midl">355042, г. Ставрополь, ул. 50 лет ВЛКСМ, д 35Е, оф 203</p>
                    </div>
                </div>
                <div class="footer__item">
                    <div class="item-first">
                ...
                <div class="footer__item">
                    ...
                    <div class="item-second">
                        <p class="text-midl">+79283296616</p>
                    </div>
                </div>
                <div class="footer__block footer__block_pb">
                    <div class="one-down border">
